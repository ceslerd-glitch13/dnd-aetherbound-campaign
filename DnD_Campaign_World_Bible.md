...
**Created:** July 2026 (compiled from detailed world-building session)

---

## 1. Core Races & Population

**Population Split (this continent):**
- Elves: ~40%
- Dwarves: ~40%
- Humans: ~20%

### Racial Relations
- **No inherent racial hatred** exists between any races.
- Elves and Dwarves do **not** hate each other simply because of their race. They have cultural friction because they think very differently:
  - **Elves**: Long-term planners who value beauty, patience, art, and harmony with nature.
  - **Dwarves**: Practical, results-oriented, focused on craft, engineering, and tangible achievements.
- This difference in worldview creates misunderstandings and tension, but it is not race-based prejudice.
- **Humans** are viewed by both Elves and Dwarves as **versatile trading partners and assistants**.
  - Humans are seen as flexible problem-solvers who can bridge gaps between the more specialized elven and dwarven cultures.
  - Elves in particular often prefer human assistants over dwarves because humans are generally more adaptable and less stubborn.

### Subraces
- All standard 5th Edition D&D subraces for Elves, Dwarves, and Humans exist in this world.
- Players may choose any official subrace without restriction.
...
These three cities are very large, extremely well-defended, and function almost like **racial capitals**.

### The Three Gate Cities

| City          | Race Control     | Notes                                      |
|---------------|------------------|--------------------------------------------|
...
## 5. Cities of the Continent

### Major Cities (15 total)
**Breakdown:**
- 6 Elven
- 6 Dwarven
- 3 Human-influenced / Mixed (one of which is the gate city Ravensport)

**Named Major Cities:**

**Elven Major Cities (6)**
- Faerindel (Gate City)
- Silvandar
- Eloweth
- Thalorien
...
**Human-influenced / Mixed Major Cities (3)**
- Ravensport (Gate City, heavily mixed)
- Havenport
- Newbridge

### Minor / Sub-Cities (20 total)
**Breakdown:**
- 8 Elven
- 8 Dwarven
- 4 Mixed
...
- Future sessions can expand on:
  ...
  - Player character backstories tied to the gates or crystals
  - The nature of the other dimensions connected by the gates

---

## 8. Rules & Mechanics (5e Foundation + Homebrew)

This campaign runs on **Dungeons & Dragons 5th Edition** as the core ruleset, with targeted homebrew elements to support the world's unique features (magic dead zones, Aetherite technology, dimensional gates).

### Core Rulebooks & References
- **Primary Source**: *Player's Handbook* (PHB), *Dungeon Master's Guide* (DMG), *Monster Manual* (MM)
- **Additional Official Content**: Xanathar's Guide to Everything, Tasha's Cauldron of Everything, Fizban's Treasury of Dragons (where relevant for dragons/other planes), Mordenkainen's Monsters of the Multiverse
- All standard 5e races, classes, spells, feats, and backgrounds are available unless noted as restricted by world lore.
...
- Character backstories can include "Aetherite-touched" or "Dead Zone Survivor" backgrounds for mechanical benefits/drawbacks.
...
**Aetherion** (The Forgemaster, The Crystal Architect)  
- Domain: Technology, invention, craftsmanship, progress, dimensional trade.  
- Alignment: Lawful Neutral.  
- Symbol: A glowing blue crystal gear.  
- **Current Status**: The most powerful deity on the continent due to the rise of Aetherite technology, firearms, and gate-based commerce.

**Elyndra** – Goddess of Arcane Weave & Natural Magic  
- Domain: Raw arcane magic, nature’s harmony, ancient forests, elven traditions.  
- Alignment: Neutral Good.  
- Symbol: A silver leaf entwined with glowing runes.

**Thalor** – God of Divine Essence & Healing Magic  
- Domain: Healing, divine magic, life force, protection from unnatural drains.  
