...
> ---
> 
### Other / Miscellaneous (Not marked with > — these get cleared on archive)
- Workflow improvements: Merge redundant sections in skill, add System Overview, improve Pending_Changes structure with examples, ensure all guidelines point to change log. (Requested by user for better pointer clarity on complex quests/NPCs)
